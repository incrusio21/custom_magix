...
frappe.provide("magix.accounts");

cur_frm.cscript.tax_table = "Purchase Taxes and Charges";

erpnext.accounts.payment_triggers.setup("Petty Cash");
erpnext.accounts.taxes.setup_tax_filters("Purchase Taxes and Charges");
erpnext.accounts.taxes.setup_tax_validations("Petty Cash");
erpnext.buying.setup_buying_controller();

magix.accounts.PettyCash = class PettyCash extends erpnext.buying.BuyingController {
	setup(doc) {
...
cur_frm.script_manager.make(magix.accounts.PettyCash);

// Hide Fields
// ------------
function hide_fields(doc) {
	var parent_fields = ["due_date", "is_opening", "from_date", "to_date"];
